...
class IR:
    ...
    def __init__(self, pin, cfreq, asize, duty, verbose):
        if ESP32:
            ...
            self._rmt = RMT(0, pin=pin, clock_div=80, tx_carrier=(cfreq,duty,1))  # 1μs resolution # AO 24/9/2021
    ...
    def trigger(self):  # Used by NEC to initiate a repeat frame
        if ESP32:
            ...
            self._rmt.write_pulses(tuple(self._mva[0 : self.aptr]), 1) # AO 24/9/2021
        elif RP2:
            self.append(STOP)
